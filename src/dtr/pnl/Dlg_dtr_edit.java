...
public class Dlg_dtr_edit extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public OutputData(String am_arrival, String pm_departure, double undertime_hours, double undertime_minutes) {
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel2.setText("AM Arrival:");

        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setText("PM Departure:");

        jTextField2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel4.setText("Undertime:");
    ...
    public void do_pass(Dtrs.to_dtrs to) {
        jTextField1.setText(to.am_arrival);
        jTextField2.setText(to.pm_departure);
        jTextField3.setText(FitIn.fmt_woc(to.undertime_hours));
        jTextField4.setText(FitIn.fmt_woc(to.undertime_minutes));
    }
...
//                btn_0.doClick();
    ...
    private void ok() {
        String am_arrival=jTextField1.getText();
        String pm_departure=jTextField2.getText();
        double undertime_hours=FitIn.toDouble(jTextField3.getText());
        double undertime_minutes=FitIn.toDouble(jTextField4.getText());

        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(am_arrival,pm_departure,undertime_hours,undertime_minutes));
        }
    }
}

...
import dtr.shifting.Dlg_employee_shiftings;
...
import dtr.users.Users;
import dtr.util.Alert;
import dtr.util.DateType;
import dtr.util.MyFrame;
...
public class Pnl_Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel51.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/menu53.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/FOLDER - DOCUMENTS_32x32-32.png"))); // NOI18N
        jLabel7.setText("Philippine Ports Authority");
...
//        check_credentials();
    ...
    private void myInit() {
        ...
        String business_name = System.getProperty("business_name", "Philippine Ports Authority");
...
//                    shifting();
                ...
                if (data.stmt.equals("Divisions")) {
                    departments();
                }
                if (data.stmt.equals("Employees")) {
                    employees();
                }
    ...
    private void holidays() {
        Dlg_holidays dtc = new Dlg_holidays();
        MyFrame.set(dtc.getSurface(), jPanel1, "Holidays");
    }
    ...
    private void shifting() {
        Dlg_employee_shiftings dtc = new Dlg_employee_shiftings();
        MyFrame.set(dtc.getSurface(), jPanel1, "Shifting");
    }

    private void departments() {
        Dlg_departments dtc = new Dlg_departments();
        MyFrame.set(dtc.getSurface(), jPanel1, "Departments");
    }

    private void employees() {
        Dlg_employees dtc = new Dlg_employees();
        MyFrame.set(dtc.getSurface(), jPanel1, "Employees");
    }

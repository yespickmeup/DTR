...
import dtr.users.S1_user_previleges;
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/pen13.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/clock154.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/progression.png"))); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/communication (1).png"))); // NOI18N
    ...
    private void jLabel8MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseEntered
        label("Holidays", jLabel8);
    }//GEN-LAST:event_jLabel8MouseEntered

    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        ok("Sick Leaves", jLabel9);
    }//GEN-LAST:event_jLabel9MouseClicked

    private void jLabel9MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseEntered
        label("Sick Leaves", jLabel9);
    }//GEN-LAST:event_jLabel9MouseEntered

    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ok("Shifting", jLabel10);
    }//GEN-LAST:event_jLabel10MouseClicked

    private void jLabel10MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseEntered
        label("Shifting", jLabel10);
    ...
    private void hover() {
        JLabel[] lbl = {jLabel7, jLabel8, jLabel9, jLabel10};
    ...
    private void set_previledge() {
        ...
        for (S1_user_previleges.to_user_previleges to : datas) {
            if (to.previledge.equalsIgnoreCase("DTR")) {
                jLabel7.setEnabled(true);
                jLabel7.setBackground(new java.awt.Color(96, 188, 219));
            }

            if (to.previledge.equalsIgnoreCase("Holidays")) {
                jLabel8.setEnabled(true);
                jLabel8.setBackground(new java.awt.Color(96, 188, 219));
            }
            if (to.previledge.equalsIgnoreCase("Sick Leaves")) {
                jLabel9.setEnabled(true);
                jLabel9.setBackground(new java.awt.Color(96, 188, 219));
            }
            if (to.previledge.equalsIgnoreCase("Shifting")) {

...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/manager3.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/team2.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dtr/icons/banking2.png"))); // NOI18N
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ok("Employees", jLabel8);
    }//GEN-LAST:event_jLabel8MouseClicked

    private void jLabel8MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseEntered
        label("Employees", jLabel8);
    ...
    private void set_previledge() {
        ...
        for (S1_user_previleges.to_user_previleges to : datas) {
            ...
            if (to.previledge.equalsIgnoreCase("Employees")) {
                jLabel8.setEnabled(true);
                jLabel8.setBackground(new java.awt.Color(96, 188, 219));
            }
            if (to.previledge.equalsIgnoreCase("Departments")) {

...
import dtr.users.S1_user_default_previleges.to_user_default_previleges;
import dtr.users.S1_user_previleges.to_user_previleges;
import dtr.users.Users.to_users;

import dtr.util.Alert;
import dtr.util.Courier;
        ...
        jXPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jXPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tf_screen_name, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//                btn_0.doClick();
    ...
    private void add_users() {
        ...
        Users.to_users to = new Users.to_users(id, user_name, screen_name, password, user_level, date_added);
        Users.add_data(to);
        data_cols();
        clear_users();
        Alert.set(1, "");
    ...
    private void edit_users() {
        ...
        String date_added = DateType.datetime.format(new Date());
        Users.to_users to1 = new Users.to_users(id, user_name, screen_name, password, user_level, date_added);
